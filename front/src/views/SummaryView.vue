  ...
  <div class="container">
    ...
    <div class="toc">
      <ol>
        ...
        <li><a href="#sum-13" class="anchor">Retrospective</a></li>
      </ol>
    </div>
    <div class="summary">
      ...
      <p>
        Consider a simple screen structure. Detailed designs are not drawn up in
        wireframes, but considered as they are implemented.
      </p>
      <p>
        A one-column design was used for the layout throughout the weitebs. This
        is because it is relatively easy to make responsive and make it looks
        simple. Footers and headers are placed on all pages as common
        components.
      </p>
      <img src="/assets/summary/wf.jpg" alt="main wireframe" width="500" />
      <h4>Chat page</h4>
      <p>
        The design of the chat page is based on Slack, Microsoft Teams and other
        chat applications as a reference because most chat apps design are
        generally similar and are considered to be sophisticated.
      </p>
      <img src="/assets/summary/wf-chat.jpg" alt="chat wireframe" width="500" />
      <h4>Wiki page</h4>
      <p>
        In wiki page, detailed information is able to be opened and closed, and
        the expanded area should be editable. It should be controlled in place
        so that multiple items can not be edited at the same time.
      </p>
      <img src="/assets/summary/wf-wiki.jpg" alt="wiki wireframe" width="500" />
      ...
      <p>
        最新バージョンのVue.jsは、ビルドにViteを使用している。Viteとは....
        package.jsonのビルド関係のスクリプトは以下のように設定された。devとpreviewは開発用コマンドである。
      </p>
      <pre><coe>
      /* package.json */
      ...
      <p>
        ...
        <a
          ...
          >Quick start guide</a
        >
        . Executed <code>npm install element-plus</code> and edited main.js file
        as below.
      </p>
      <pre><code>
      /* main.js */
      ...
      <ul>
        ...
        <li>
          <code>saveInfo</code>... send PUT request with edited data, then send
      ...
      <p>
        ...
        components are prepared.<br /><br />The directory structure on the
        client side(Vue.js) is as follows, with the content of each page divided
        into files in component units.
      </p>
      <pre><code>
      > front
          > node_modules
      ...
      <p>
        ...
        For example, in the case of <code>/about</code> access, a screen with an
        embedded <code>&lt;AboutView></code> in App.vue will be displayed.
      </p>
      <p>
        Regarding the syntax of the .vue file, the main feature is that each
        .vue file is constructed by three part, Javascript, HTML, and CSS. This
        is the example of <code>AboutView.vue</code>.
      </p>
      <pre><code>
        /* view/AboutView.vue */
        &lt;script>&lt;/script>
      ...
      <p>
        ...
        Javascript in this example), HTML is in <code>&lt;template></code> part
        and CSS is <code>&lt;style></code> part.
      </p>
      <p>
        The advantage is that it is easier to manage components, as all the
        methods, part configurations and styles required to display a component
        can be found in a single file.
      </p>
      ...
      <p>
        ...
        local development environment were different, and Codio's Node
        <code>v15</code> did not seem to support Vue.js <code>v3</code>.
        Therefore, Node.js and npm in Codio were downgraded to match the local
        version, <code>v14.18.1</code> and <code>v6.14.15</code> For the version
        change, a Node.js version control library called n had to be installed.
      </p>
      <pre><code>
      ...
      <p>
        This confirmed that the build was successful and that the server worked
        correctly in Codio.
      </p>

      <h3 id="sum-11">11. Refactoring</h3>
      <p>
        After the pages and functions were implemented, refactoring was done to
        make the code better. Examples of refactoring are below.
      </p>
      <ul>
        <li>
